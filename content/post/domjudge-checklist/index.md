...
description: ICPC比赛赛前部署&性能优化检查清单
...
1. Normal install according to [official manual](https://www.domjudge.org/docs/manual/9.0/index.html)
...
5. Create cache path with following commands

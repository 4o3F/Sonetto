...
pubDatetime: 2023-11-25T00:00:00.000Z
draft: false
tags:
  - "adb"
  - "dev"
...
## ADB无线调试连接协议
协议全过程总览，drawio文件[在这里](/post-attachments/adb-tls-protocol/adb_tls_connect.drawio)  
![ADB TLS 无线调试连接协议全过程总览](./adb_tls_connect.png)
### 数据包格式
所有数据包的定义如下

<details>
<summary>数据包定义</summary>
